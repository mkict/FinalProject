...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartApplication = __webpack_require__(168);

	var _CartApplication2 = _interopRequireDefault(_CartApplication);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store;
	_reactDom2.default.render(_react2.default.createElement(_CartApplication2.default, { store: store }), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartList = __webpack_require__(169);

	var _CartList2 = _interopRequireDefault(_CartList);

	var _ProductList = __webpack_require__(170);

	var _ProductList2 = _interopRequireDefault(_ProductList);

	var _cartReducer = __webpack_require__(171);

	var _cartReducer2 = _interopRequireDefault(_cartReducer);

	var _cartAction = __webpack_require__(172);
	...
	var CartApplication = function (_React$Component) {
	    _inherits(CartApplication, _React$Component);

	    function CartApplication() {
	        _classCallCheck(this, CartApplication);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CartApplication).apply(this, arguments));
	    }

	    _createClass(CartApplication, [{
	        key: 'render',
	...
	exports.default = CartApplication;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cartReducer() {
		...
		switch (actions.type) {
			case _cartAction.ADD_PRODUCT_TO_CART:
				return _extends({}, state, { cartList: [].concat(_toConsumableArray(state.cartList), [actions.item]) });
			case _cartAction.REMOVE_PRODUCT_FROM_CART:
				break;
			default:
				return state;
		}
...
/***/ function(module, exports) {
	...
	var ADD_PRODUCT_TO_CART = exports.ADD_PRODUCT_TO_CART = "ADD_PRODUCT_TO_CART";
	var REMOVE_PRODUCT_FROM_CART = exports.REMOVE_PRODUCT_FROM_CART = "REMOVE_PRODUCT_FROM_CART";
